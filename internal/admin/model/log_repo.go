...
type LogRepository struct {
	...
	SumUsedQuotaByUserIdWithModelAndToken func(logType int, userId string, startTimestamp int64, endTimestamp int64, modelName string, tokenName string) (int64, error)
