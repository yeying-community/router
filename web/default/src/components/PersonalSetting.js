...
const PersonalSetting = () => {
  ...
  const bindWallet = async () => {
    try {
      ...
      const nonceResp = await API.post('/api/v1/public/common/auth/challenge', { address, chain_id });
      ...
      const res = await API.post('/api/oauth/wallet/bind', { address, signature, nonce: nonceData.nonce, chain_id });
